...
* **Der biologische Vektor:** Unter extremem Todes- und Verfolgungsdruck führt niemand komplexe mathematische Verschiebungen (wie Shift-Minus-4) im Kopf aus. Das System muss unter Adrenalin augenblicklich, stressresistent und fehlerfrei funktionieren.
* **Der Telegramm-Stil:** Akteure unter Zeit- und Lebensdruck verfassen keine Romane, sondern fragmentarische, präzise Statusmeldungen.

---

## 2. Die Motiv-Herleitung: Warum „Vergewaltigung & Trauma“ als Kernvektor?

Die Hypothese eines Rache- oder Schutzaktes im Umfeld von Jessica Harkness („Jestyn“) basiert auf einer unbestechlichen Synopse aus Genetik, Verhaltensbiologie und Aktenlage:

1. **Das unerschütterliche Vaterschafts-Schweigen:**  
   Jestyn verweigerte zeit ihres Lebens (und bis zu ihrem Tod 2007) jede Aussage dazu, wer der leibliche Vater ihres Sohnes Robin (* 01.11.1947) war. In einer von gesellschaftlicher Konvention geprägten Nachkriegsgesellschaft ist ein solches eisernes, lebenslanges Mauern das klassische Schutzverhalten nach einem gravierenden sexuellen Trauma.
2. **Die extreme biologische Merkmals-Konvergenz (Die Falle):**  
   ...
   *Der Fehlschluss:* Das Umfeld um Jestyn/Boxall musste bei der Begegnung mit Carl Webb in Glenelg zwangsläufig davon ausgehen, das lebende Gesicht des Täters/Vergewaltigers vor sich zu haben. 
3. **Die Zäsur von 2022 (Die DNA-Beweisführung):**  
   Erst die genetische Untersuchung von Prof. Derek Abbott im Jahr 2022 bewies zweifelsfrei: **Carl Webb war NICHT der Vater von Robin.** Da Jestyn und Boxall (gestorben 1995) lange vor 2022 starben, erlebten sie diese Aufklärung nie. Sie agierten 1948 in dem absoluten Glauben, den echten Peiniger zu neutralisieren.
...
SOMERTON-MANN-MATRIX
 ├── PFAD A: Spionage- & Code-Matrix
 │    └─ (Decoy, Dead-Drop, Mechanischer Q-Anker)
 │
 └── PFAD B: Rache-, Trauma- & Alibi-Rochade
...
* **Der Vollzugs-Auftrag:**  
  Nachdem Jestyn von der vermeintlichen Bedrohung durch den scheinbaren Täter (Webb) berichtete, übernahm der operativ geschulte Boxall die Bereinigung. Die Kleidung des Opfers wurde anonymisiert (Labels herausgetrennt), der eingenähte *Tamam-Shud*-Streifen diente als finale Vollzugsmeldung (*„Es ist beendet“*).
...
* **Das unumstößliche Alibi:**  
  Als die Polizei im August 1949 bei Boxall anklopfte, legte er seelenruhig dieses unversehrte Ersatz-Exemplar mit der *JEstin*-Signatur vor und wurde von den Ermittlern als „entlastet“ zu den Akten gelegt.
